...
import { GetWiFiDisplayerIP, TestWiFiDisplayerConnection, SaveWiFiCredentialsAuto } from 'wailsjs/go/handlers/DisplayerHandler.js';

export default function QRDisplayerWiFiSetup() {
  ...
  return (
    <div className="card">
      <div className="card-header">
        <span className="card-title">ตั้งค่าหน้าจอแสดง QR Code</span>
      </div>
